...
- Proposal: `openspec/changes/i18n-multilingual/proposal.md`
- Spec: `openspec/changes/i18n-multilingual/spec.md`
- Tasks: `openspec/changes/i18n-multilingual/tasks.md`
- Verify Report: `openspec/changes/i18n-multilingual/verify.md`
- State: `openspec/changes/i18n-multilingual/state.yaml`
- Archive Report: `openspec/changes/i18n-multilingual/archive.md` + `openspec/changes/archive/2026-07-30-i18n-multilingual/archive.md`
