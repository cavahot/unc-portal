...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('pages.facultades.odontologia.meta')
...
const ARANCELES = {
  ...
  venta: [
    ...
    { concepto: 'Formulario de inscripción a pasantía', monto: '300.000' },
    { concepto: 'Formulario de inscripción', monto: '300.000' },
  ],
  servicios: [
    { concepto: 'Matrícula Curso Taller', monto: '500.000' },
    { concepto: 'Matrícula Curso Prótesis Dental', monto: '300.000' },
    { concepto: 'Matrícula Curso Odontología', monto: '500.000' },
    { concepto: 'Cuota Curso Taller', monto: '300.000' },
    { concepto: 'Cuotas Curso Prótesis Dental', monto: '150.000' },
    { concepto: 'Cuotas Curso Odontología', monto: '250.000' },
    { concepto: 'Cuotas Recursante Prótesis', monto: '75.000' },
    { concepto: 'Cuotas Recursante Odontología', monto: '125.000' },
    { concepto: 'Cuotas Posgrado', monto: '1.000.000' },
    ...
    { concepto: 'Derecho de Examen Recuperatorio', monto: '50.000' },
    { concepto: 'Matrícula Posgrado', monto: '500.000' },
    { concepto: 'Derecho a Defensa TCC', monto: '300.000' },
    { concepto: 'Solicitud cambio de carrera', monto: '300.000' },
    { concepto: 'Reincorporación a cursos de grado', monto: '500.000' },
  ],
  medicos: [
    { concepto: 'Usufructo de Clínica', monto: '450.000' },
    { concepto: 'Usufructo de Laboratorio y/o preclínica', monto: '450.000' },
  ],
}
...
const DEMO_GRADO = [
  { id: 1, nombre: 'Odontología',                  sede: 'Central/Concepción', resolucion: '165/15' },
  { id: 2, nombre: 'Licenciatura en Prótesis Dental', sede: 'Central/Concepción', resolucion: '709/16' },
  { id: 3, nombre: 'Odontología (reacreditación)',  sede: 'Central/Concepción', resolucion: '497/21' },
]

const DEMO_POSGRADO = [
  { id: 4,  nombre: 'Especialización en Rehabilitación Oral',                          sede: 'Central/Concepción', resolucion: '18/16' },
  { id: 5,  nombre: 'Especialización en Ortodoncia Correctiva y Ortopedia Facial',     sede: 'Central/Concepción', resolucion: '19/16' },
  { id: 6,  nombre: 'Especialización en Implantología Oral',                           sede: 'Central/Concepción', resolucion: '20/16' },
  { id: 7,  nombre: 'Especialización en Endodoncia',                                   sede: 'Central/Concepción', resolucion: '21/16' },
  { id: 8,  nombre: 'Especialización en Ortopedia Funcional de los Maxilares',         sede: 'Central/Concepción', resolucion: '34/16' },
  { id: 9,  nombre: 'Especialización en Estética y Cosmética Dental',                  sede: 'Central/Concepción', resolucion: '35/16' },
]
...
export default async function OdontologiaPage() {
  ...
  const t      = await getTranslations('pages.facultades.odontologia')

  const SLUG = 'facultad-de-odontologia'
  ...
  return (
    <main className="min-h-screen bg-[#0c1c0c] text-slate-100">
      ...
      <section className="relative overflow-hidden border-b border-[#5CFF5C]/10">
        ...
        />
        {/* Soft glow */}
        <div aria-hidden className="pointer-events-none absolute -right-20 top-0 h-80 w-80 rounded-full bg-[#5CFF5C]/6 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
            ...
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-2xl border border-[#5CFF5C]/20 bg-[#5CFF5C]/8 p-3 shadow-lg shadow-[#5CFF5C]/5 sm:h-36 sm:w-36">
              <Image
                src="/images/facultades/odontologia.png"
                alt="Logo Facultad de Odontología"
                width={120}
                height={120}
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 space-y-16">
        ...
        <section aria-labelledby="aranceles-heading">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div>
              <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-[#5CFF5C]">
                {t('aranceles.grupos.medicos')}
              </h3>
              <ArancelTable rows={ARANCELES.medicos} />
            </div>
            ...
            <div className="sm:col-span-2">
              <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-[#5CFF5C]">
                {t('aranceles.grupos.servicios')}
              </h3>
              <ArancelTable rows={ARANCELES.servicios} />
            </div>
          </div>
        </section>
        ...
        <section aria-labelledby="contacto-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="tel:+5953312416800" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.telefono')}
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <div className="space-y-1">
                <a href="mailto:decanatofo@unc.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">decanatofo@unc.edu.py</a>
                <a href="mailto:secretariagralfo@unc.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">secretariagralfo@unc.edu.py</a>
              </div>
            </div>
