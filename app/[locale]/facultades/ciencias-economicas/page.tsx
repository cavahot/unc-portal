...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('pages.facultades.ciencias-economicas.meta')
...
const ARANCELES = {
  ...
  academicos: [
    { concepto: 'Matrícula Grado', monto: '300.000' },
    ...
    { concepto: 'Matrícula Doctorado', monto: '1.500.000' },
    { concepto: 'Cuotas Doctorado', monto: '1.500.000' },
    ...
    { concepto: 'Defensa de Tesis Maestría', monto: '1.000.000' },
    { concepto: 'Defensa de Tesis Doctorado', monto: '2.000.000' },
    { concepto: 'Solicitud cambio de carrera', monto: '300.000' },
    { concepto: 'Reincorporación', monto: '500.000' },
  ],
  campo: [
    { concepto: 'Uso de Laboratorio de Informática', monto: '450.000' },
  ],
}
...
const DEMO_GRADO = [
  { id: 1, nombre: 'Ingeniería Comercial',                    sede: 'Concepción',      resolucion: undefined },
  { id: 2, nombre: 'Ingeniería en Informática Empresarial',   sede: 'Concepción',      resolucion: undefined },
  { id: 3, nombre: 'Licenciatura en Administración',          sede: 'Central/Horqueta', resolucion: undefined },
  { id: 4, nombre: 'Contaduría Pública',                      sede: 'Central/Horqueta', resolucion: undefined },
]

const DEMO_POSGRADO = [
  { id: 5,  nombre: 'Especialización en Administración Financiera Gubernamental', sede: 'Central/Concepción', resolucion: '518/16' },
  { id: 6,  nombre: 'Maestría en Administración y Dirección de Empresas',         sede: 'Central/Concepción', resolucion: '561/16' },
  { id: 7,  nombre: 'Maestría en Auditoría',                                       sede: 'Central/Concepción', resolucion: '564/16' },
  { id: 8,  nombre: 'Especialización en Auditoría Impositiva',                     sede: 'Horqueta',           resolucion: '528/17' },
  { id: 9,  nombre: 'Maestría en Analítica de Datos en el Área Empresarial',       sede: 'Concepción',         resolucion: '136/21' },
  { id: 10, nombre: 'Maestría en Contabilidad y Finanzas',                          sede: 'Central/Concepción', resolucion: '348/22' },
  { id: 11, nombre: 'Especialización en Dirección y Gestión de Mipymes',            sede: 'Central/Concepción', resolucion: '100/24' },
  { id: 12, nombre: 'Doctorado en Administración y Dirección de Empresas',          sede: 'Central/Concepción', resolucion: '101/24' },
]
        ...
        <tbody className="divide-y divide-[#5CFF5C]/8">
          {rows.map(row => (
            <tr key={row.id} className="transition-colors hover:bg-[#5CFF5C]/5">
              ...
              <td className="px-5 py-3.5 text-slate-400">{row.sede ?? 'Concepción'}</td>
...
export default async function CienciasEconomicasPage() {
  const locale = await getLocale()
  const t      = await getTranslations('pages.facultades.ciencias-economicas')

  const SLUG = 'facultad-de-ciencias-economicas-y-administrativas'
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
            ...
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-2xl border border-[#5CFF5C]/20 bg-[#5CFF5C]/8 p-3 shadow-lg shadow-[#5CFF5C]/5 sm:h-36 sm:w-36">
              <Image
                src="/images/facultades/economicas.png"
                alt="Logo Facultad de Ciencias Económicas y Administrativas"
                width={120}
                height={120}
        ...
        <section aria-labelledby="contacto-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="tel:+595331241749" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.telefono')}
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="mailto:secretariageneral@fcea-unc.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                secretariageneral@fcea-unc.edu.py
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="https://www.fcea-unc.edu.py" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.web')}
              </a>
              <a href="https://www.fcea-unc.edu.py" target="_blank" rel="noopener noreferrer" className="mt-auto inline-flex items-center gap-1.5 text-xs font-semibold text-[#5CFF5C] hover:underline">
                {t('contacto.sitio')}
