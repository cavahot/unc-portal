...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('pages.facultades.humanidades.meta')
...
const ARANCELES = {
  ...
  academicos: [
    { concepto: 'Matrícula Grado', monto: '200.000' },
    { concepto: 'Cuota mensual Grado', monto: '100.000' },
    { concepto: 'Cuota Recursante', monto: '50.000' },
    { concepto: 'Matrícula Posgrado', monto: '350.000' },
    { concepto: 'Cuotas Maestría', monto: '700.000' },
    { concepto: 'Matrícula Especialización', monto: '350.000' },
    ...
    { concepto: 'Defensa de Tesis / TFG (Grado)', monto: '250.000' },
    { concepto: 'Defensa de Tesis (Posgrado)', monto: '1.000.000' },
...
const DEMO_GRADO = [
  { id: 1, nombre: 'Licenciatura en Ciencias de la Educación',                         sede: 'Central/Concepción', resolucion: '156/15'   },
  { id: 2, nombre: 'Licenciatura en Psicopedagogía',                                   sede: 'Central/Concepción', resolucion: '162/15'   },
  { id: 3, nombre: 'Licenciatura en Interculturalidad',                                sede: 'Central/Concepción', resolucion: '263/16'   },
  { id: 4, nombre: 'Licenciatura en Trabajo Social',                                   sede: 'Central/Concepción', resolucion: '560/16'   },
  { id: 5, nombre: 'Licenciatura en Ciencias de la Comunicación Social',               sede: 'Concepción',         resolucion: '710/17'   },
  { id: 6, nombre: 'Psicología',                                                        sede: 'Concepción',         resolucion: '137/21'   },
  { id: 7, nombre: 'Licenciatura en Educación de la Lengua y Literatura Castellana',   sede: 'Central/Concepción', resolucion: '36/2024'  },
]

const DEMO_POSGRADO = [
  { id: 8,  nombre: 'Especialización en Investigación Científica',        sede: 'Central/Concepción', resolucion: '284/16' },
  { id: 9,  nombre: 'Especialización en Mediación de Conflictos',         sede: 'Central/Concepción', resolucion: '443/22' },
  { id: 10, nombre: 'Maestría en Educación Indígena e Intercultural',     sede: 'Central/Concepción', resolucion: '96/23'  },
]
...
export default async function HumanidadesPage() {
  const locale = await getLocale()
  const t      = await getTranslations('pages.facultades.humanidades')

  const SLUG = 'facultad-de-humanidades-y-ciencias-de-la-educacion'
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
            ...
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-2xl border border-[#5CFF5C]/20 bg-[#5CFF5C]/8 p-3 shadow-lg shadow-[#5CFF5C]/5 sm:h-36 sm:w-36">
              <Image
                src="/images/facultades/humanidades.png"
                alt="Logo Facultad de Humanidades y Ciencias de la Educación"
                width={120}
                height={120}
        ...
        <section aria-labelledby="contacto-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="tel:+595331243176" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.telefono')}
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <div className="space-y-1">
                <a href="mailto:secgral@fhyce.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">secgral@fhyce.edu.py</a>
                <a href="mailto:administracion@fhyce.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">administracion@fhyce.edu.py</a>
              </div>
            </div>
