...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('pages.facultades.medicina.meta')
...
const ARANCELES = {
  ...
  academicos: [
    { concepto: 'Matrícula Carrera de Medicina', monto: '500.000' },
    { concepto: 'Cuota Carrera de Medicina', monto: '350.000' },
    { concepto: 'Cuota Recursante', monto: '175.000' },
    ...
    { concepto: 'Derecho a Defensa TFG', monto: '300.000' },
    { concepto: 'Solicitud cambio de carrera', monto: '300.000' },
    { concepto: 'Reincorporación', monto: '500.000' },
  ],
  clinicos: [
    { concepto: 'Usufructo de Equipos y Laboratorio', monto: '450.000' },
    { concepto: 'Prácticas en Hospital Escuela (por semestre)', monto: '450.000' },
  ],
}
...
const DEMO_GRADO = [
  { id: 1, nombre: 'Medicina', sede: 'Central/Concepción', resolucion: '160/16' },
]

const DEMO_POSGRADO = [
  { id: 2, nombre: 'Especialización en Salud Pública',                      sede: 'Central/Concepción', resolucion: '72/16'  },
  { id: 3, nombre: 'Especialización en Medicina Familiar y Comunitaria',    sede: 'Concepción',         resolucion: '157/18' },
]
...
export default async function MedicinaPage() {
  ...
  const t      = await getTranslations('pages.facultades.medicina')

  const SLUG = 'facultad-de-medicina'
  ...
  return (
    <main className="min-h-screen bg-[#0c1c0c] text-slate-100">
      ...
      <section className="relative overflow-hidden border-b border-[#5CFF5C]/10">
        ...
        />
        {/* Soft glow */}
        <div aria-hidden className="pointer-events-none absolute -left-20 top-0 h-80 w-80 rounded-full bg-[#5CFF5C]/6 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
            ...
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-2xl border border-[#5CFF5C]/20 bg-[#5CFF5C]/8 p-3 shadow-lg shadow-[#5CFF5C]/5 sm:h-36 sm:w-36">
              <Image
                src="/images/facultades/medicina.png"
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                {[
                  { label: 'Carrera de Grado',    value: grado.length    },
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 space-y-16">
        ...
        <section aria-labelledby="aranceles-heading">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div>
              <h3 className="mb-3 text-sm font-semibold uppercase tracking-wider text-[#5CFF5C]">
                {t('aranceles.grupos.clinicos')}
              </h3>
              <ArancelTable rows={ARANCELES.clinicos} />
            </div>
        ...
        <section aria-labelledby="contacto-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="tel:+595331242591" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.telefono')}
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <div className="space-y-1">
                <a href="mailto:fm-secretariageneral@unc.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                  fm-secretariageneral@unc.edu.py
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a
                href="https://www.fmedicina-unc.edu.py"
                target="_blank"
