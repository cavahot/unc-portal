...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations('pages.facultades.agrarias.meta')
...
const ARANCELES = {
  ...
  academicos: [
    ...
    { concepto: 'Defensa de Tesis / TFG', monto: '1.000.000' },
    { concepto: 'Solicitud cambio de carrera', monto: '300.000' },
    { concepto: 'Reincorporación', monto: '500.000' },
  ],
  campo: [
    { concepto: 'Usufructo de Laboratorio y Equipos', monto: '450.000' },
    { concepto: 'Prácticas de Campo (por semestre)', monto: '350.000' },
  ],
}
...
const DEMO_GRADO = [
  { id: 1, nombre: 'Ingeniería Agronómica',                                       sede: 'Central/Concepción', resolucion: '556/16' },
  { id: 2, nombre: 'Licenciatura en Administración Agropecuaria (Horqueta)',      sede: 'Horqueta',           resolucion: '557/16' },
  { id: 3, nombre: 'Licenciatura en Administración de Agronegocios',              sede: 'Central/Concepción', resolucion: '563/16' },
  { id: 4, nombre: 'Licenciatura en Administración Agropecuaria (Fuerte Olimpo)', sede: 'Fuerte Olimpo',      resolucion: '372/21' },
  { id: 5, nombre: 'Licenciatura en Administración Agropecuaria (Yby Yau)',       sede: 'Yby Yau',            resolucion: '375/21' },
]

const DEMO_POSGRADO = [
  { id: 6, nombre: 'Maestría en Producción Vegetal',                              sede: 'Central/Concepción', resolucion: '562/16' },
  { id: 7, nombre: 'Maestría en Zootecnia',                                       sede: 'Concepción',         resolucion: '992/19' },
  { id: 8, nombre: 'Especialización en Fertilidad del Suelo y Nutrición de Plantas', sede: 'Central/Concepción', resolucion: '553/22' },
]
...
export default async function AgrariaPage() {
  const locale = await getLocale()
  const t      = await getTranslations('pages.facultades.agrarias')

  const SLUG = 'facultad-de-ciencias-agrarias'
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center">
            ...
            <div className="flex h-28 w-28 shrink-0 items-center justify-center rounded-2xl border border-[#5CFF5C]/20 bg-[#5CFF5C]/8 p-3 shadow-lg shadow-[#5CFF5C]/5 sm:h-36 sm:w-36">
              <Image
                src="/images/facultades/agrarias.png"
                alt="Logo Facultad de Ciencias Agrarias"
                width={120}
                height={120}
        ...
        <section aria-labelledby="contacto-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <a href="tel:+595331241813" className="text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">
                {t('contacto.telefono')}
              </a>
            </div>
            ...
            <div className="flex flex-col gap-2 rounded-xl border border-[#5CFF5C]/15 bg-[#5CFF5C]/5 p-5">
              ...
              <div className="space-y-1">
                <a href="mailto:secgralfcaunc@gmail.com" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">secgralfcaunc@gmail.com</a>
                <a href="mailto:fca-unc@fca-unc.edu.py" className="block text-sm text-slate-300 transition-colors hover:text-[#5CFF5C]">fca-unc@fca-unc.edu.py</a>
              </div>
            </div>
